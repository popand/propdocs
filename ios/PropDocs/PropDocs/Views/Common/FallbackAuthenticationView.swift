...
struct FallbackAuthenticationView: View {
    ...
    private var canSkipAuthentication: Bool {
        return !biometricManager.policyConfiguration.requireBiometrics
    }
    ...
    private func authenticateWithPasscode() async {
        let result = await biometricManager.authenticateWithFallback(reason: "Authenticate with passcode to access PropDocs")
