...
class APIClient {
    ...
    private init() {
        ...
        baseURL = URL(string: "https://api.propdocs.com/v1")!
    ...
    func post<T: Codable>(
        endpoint: APIEndpoint,
        body: T,
        responseType _: EmptyResponse.Type,
        requiresAuth: Bool = false
    ...
    private func buildRequest(
        ...
        try buildRequest(for: endpoint, method: method, body: EmptyRequest?.none, requiresAuth: requiresAuth)
    }
